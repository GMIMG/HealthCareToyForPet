...
$sql= "SELECT year, mon, sum(act) AS act FROM (SELECT year, mon, day, sum(act) AS act FROM (SELECT year, mon, day, hour, MAX(act) AS act FROM sens WHERE year=".(int)$year. " AND hour>=7 AND hour<=21 GROUP BY year, mon, day, hour)A GROUP BY year, mon, day)B GROUP BY year, mon";
